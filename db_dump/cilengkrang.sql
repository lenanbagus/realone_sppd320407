...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 05, 2022 at 09:18 AM
...
(35, '3665/PROV/256', 'Surakarta', 'Bimbingan Pengelolaan SDM Desa', '2021-12-22', '2021-12-22', '00:00:00', '21:00:00', 'Aku', 'Kamu', 'Dia', 23, '2021-12-26 17:02:13', '2021-12-28 11:15:50'),
...
(40, '005/1349/PKALD/TEST', 'Pusdikter Angkatan Darat Jalan', 'Menghadiri Pelatihan Masa Jabatan Bagi Kepala Desa Terpilih Tahun 2022', '2021-12-27', '2021-12-27', '12:02:00', '16:02:00', 'Charles', 'Michael', 'Duran', 27, '2021-12-26 17:03:00', '2021-12-29 17:32:03');
...
INSERT INTO `data_notulen` (`id`, `isi_notulen`, `id_surat`) VALUES
...
--
ALTER TABLE `data_notulen`
  ADD CONSTRAINT `data_notulen_ibfk_1` FOREIGN KEY (`id_surat`) REFERENCES `data_agenda` (`id`);
COMMIT;
