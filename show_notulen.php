                ...
                <?php while ($row = $result->fetch_assoc()) : ?>
                    ...
                    <div class="row grid-body">
                        ...
                        <div class="col-12 col-lg-2 text-center px-0">
													...
													<!-- Modal Delete #start -->
													<a href="" data-toggle="modal" data-target="#hapusNotulen-<?php echo $row['id']; ?>" class="mr-2">
														...
														<div class="modal-dialog">
															<div class="modal-content">
																...
																<div class="modal-footer">
																	...
																	<a href="process_asn.php?delete3=<?php echo $row['id']; ?>" id_agenda="<?php echo $row['id']; ?>" class="mr-2 btn btn-danger btn-delete-modal" type="button">Hapus</a>
																</div>
															</div>
														</div>
													</div>
